...
checkpoint:
  ...
  gray_areas_resolved:
    - topic: "pain category"
      decision: "invisible collections — friends' libraries are opaque, borrows never happen"
    - topic: "primary persona"
      decision: "regular book reader with a reading-adjacent friend group"
    - topic: "insight"
      decision: "public catalog removes social awkwardness of asking; browse without asking"
    - topic: "auth model"
      decision: "email+password or OAuth (Google/GitHub); persistent accounts"
    - topic: "role model"
      decision: "flat — all registered users see friends' collections equally; friend connection required to borrow"
    - topic: "MVP scope"
      decision: "full social loop: catalog + friends + borrow request + confirm; reviews are nice-to-have"
    - topic: "timeline"
      decision: "5 weeks after-hours; user explicitly accepted sustained-effort cost"
    - topic: "product type"
      decision: "web-app"
    - topic: "target scale"
      decision: "medium (dozens to ~100 users)"
    - topic: "hard deadline"
      decision: "none; after-hours only"
  frs_drafted: 12
...
## Non-Goals in MVP (it should be in v2)
...
Acknowledged on 2026-05-29: 5-week MVP requires sustained dedication over evenings and weekends; user accepted the sustained-effort cost explicitly.
